...
| Nuxt | One client plugin | `page:finish` |
...
| Astro | Shared layout script | `astro:page-load` when client routing is active |
...
2. Install either the raw script or `@bilyai/js` on a website surface, never both.
