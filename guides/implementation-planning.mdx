...
Start with Bily's [recognized event names](/api-reference/events) for commerce and common application outcomes. Use a stable snake_case [custom event](/guides/custom-events) only for a product-specific outcome that has no standard event.
