...
Use Bily's current names for standard commerce and application outcomes. Use stable snake_case names only for product-specific outcomes that have no standard event.
